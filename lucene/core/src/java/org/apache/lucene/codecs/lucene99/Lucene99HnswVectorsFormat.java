...
public class Lucene99HnswVectorsFormat extends KnnVectorsFormat {
  ...
  public Lucene99HnswVectorsFormat() {
    this(DEFAULT_MAX_CONN, DEFAULT_BEAM_WIDTH, DEFAULT_NUM_MERGE_WORKER, null, true);
  }
  ...
  public Lucene99HnswVectorsFormat(int maxConn, int beamWidth) {
    this(maxConn, beamWidth, DEFAULT_NUM_MERGE_WORKER, null, true);
  }
  ...
  public Lucene99HnswVectorsFormat(
    ...
    this(maxConn, beamWidth, numHnswThreads, mergeExec, VERSION_CURRENT, useTemporaryVectorFile);
  }
