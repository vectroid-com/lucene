...
public class Lucene102HnswBinaryQuantizedVectorsFormat extends KnnVectorsFormat {
   ...
   */
  public Lucene102HnswBinaryQuantizedVectorsFormat(
      int maxConn, int beamWidth, int numMergeWorkers, ExecutorService mergeExec, boolean useTemporaryVectorFile) {
    super(NAME);
    flatVectorsFormat = new Lucene102BinaryQuantizedVectorsFormat(useTemporaryVectorFile);
